...
{
    public class lifecycle : ISupportBulk
    {
        ...
        public async Task Call(Request.lifecycle request, CallSettings callSettings)
        {
            // Set the URL
            string url = (callSettings.isBulk ? string.Empty : callSettings.serverLocation) + "/data/lifecycle";
