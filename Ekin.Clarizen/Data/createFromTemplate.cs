...
namespace Ekin.Clarizen.Data
{
    public class createFromTemplate : ISupportBulk
    {
        ...
        public async Task Call(Request.createFromTemplate request, CallSettings callSettings)
        {
            // Set the URL
            string url = (callSettings.isBulk ? string.Empty : callSettings.serverLocation) + "/data/createFromTemplate";
